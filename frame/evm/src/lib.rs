...
pub trait OnChargeEVMTransaction<T: Config> {
    ...
    /// need to be secured.
    fn withdraw_fee(who: &H160, target: Option<&H160>, fee: U256) -> Result<Self::LiquidityInfo, Error<T>>;
    ...
    U256: UniqueSaturatedInto<<C as Currency<<T as frame_system::Config>::AccountId>>::Balance>,
{
    ...
    fn withdraw_fee(who: &H160, _target: Option<&H160>, fee: U256) -> Result<Self::LiquidityInfo, Error<T>> {
        if fee.is_zero() {
            return Ok(None);
        }
    ...
    >,
{
    ...
    fn withdraw_fee(who: &H160, _target: Option<&H160>, fee: U256) -> Result<Self::LiquidityInfo, Error<T>> {
        EVMFungibleAdapter::<T::Currency, ()>::withdraw_fee(who, _target, fee)
    }
