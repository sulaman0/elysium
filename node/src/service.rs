...
use elysium_runtime::{opaque::Block, Hash, TransactionConverter};
...
type GrandpaBlockImport<Client> = sc_consensus_grandpa::GrandpaBlockImport<FullBackend, Block, Client, FullSelectChain>;
...
impl sc_executor::NativeExecutionDispatch for ExecutorDispatch {
    ...
    fn dispatch(method: &str, data: &[u8]) -> Option<Vec<u8>> {
        elysium_runtime::api::dispatch(method, data)
    }

    fn native_version() -> sc_executor::NativeVersion {
        elysium_runtime::native_version()
    }
}
...
//     FrontierBlockImport<
//         Block,
//         sp_finality_grandpa::GrandpaBlockImport<FullBackend, Block, FullClient, FullSelectChain>,
//         FullClient,
//     >,
//     sp_finality_grandpa::LinkHalf<Block, FullClient, FullSelectChain>,
// );
//
...
pub async fn build_full(
    ...
    new_full::<elysium_runtime::RuntimeApi, TemplateRuntimeExecutor>(
...
> {
    ...
    let PartialComponents {
        ...
        other,
        ..
    } = new_partial::<elysium_runtime::RuntimeApi, TemplateRuntimeExecutor, _>(
        config,
        eth_config,
